...
static const flex_int16_t yy_base[18] =
    {   0,
        0,    0,   13,    0,   14,   14,   14,   14,    6,    4,
        2,    0,    0,    0,    0,   14,    8
    } ;

static const flex_int16_t yy_def[18] =
    {   0,
       16,    1,   16,   17,   16,   16,   16,   16,   17,   17,
       17,   17,    9,   10,   11,    0,   16
    } ;
...
YY_RULE_SETUP
#line 11 "p1.l"
{word_count++; lower_count++; char_count += yyleng;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 12 "p1.l"
{word_count++; upper_count++; char_count += yyleng;}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 13 "p1.l"
{word_count++; num_count++; char_count += yyleng;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 14 "p1.l"
